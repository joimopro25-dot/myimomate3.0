// src/components/modals/SimpleConversionModal_ScrollFixed.jsx
// VERSÃO COM SCROLL OTIMIZADO E GARANTIDO
// ======================================
...
${leadData.notes ? `Notas do lead: ${leadData.notes}` : ''}`,
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      <div className={`bg-white rounded-lg shadow-xl w-full max-w-6xl flex flex-col ${
        isDark() ? 'bg-gray-800' : 'bg-white'
      }`} style={{ height: '95vh' }}>
        
        {/* Header Fixo - NÃO ENTRA NO SCROLL */}
        ...
        {/* Área de Conteúdo Scrollável - FLEX-GROW PARA OCUPAR ESPAÇO DISPONÍVEL */}
            ...
            <div className="max-w-4xl mx-auto space-y-8">
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  />
                  <label htmlFor="temConjuge" className={`font-medium flex items-center ${
                    isDark() ? 'text-gray-200' : 'text-gray-900'
                  }`}>
                  ...
                  <div className={`p-4 rounded-lg ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="md:col-span-2">
                        ...
                        />
                        {errors.conjugeNome && (
                          <p className="text-red-500 text-xs mt-1">{errors.conjugeNome}</p>
                        )}
                      </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded text-blue-600 focus:ring-blue-500"
                  />
                  <label htmlFor="preAprovacao" className={`text-sm ${
                    isDark() ? 'text-gray-300' : 'text-gray-700'
                  }`}>
        ...
        {/* Footer Fixo - NÃO ENTRA NO SCROLL */}
